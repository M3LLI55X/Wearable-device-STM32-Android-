...
public class monthFragment extends Fragment {
    ...
    String projectType ;
    String titleType;
    private final String scale="month";
    ...
    @SuppressLint("ValidFragment")
    public monthFragment(String phone , String type)throws InterruptedException{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        lineChart = (LineChartView)view.findViewById(R.id.line_chartMonth);
