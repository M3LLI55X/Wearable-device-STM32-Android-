...
public class dayFragment extends Fragment {
    ...
    private final String scale = "hours";
    String projectType ;
    String titleType;
    ...
    @SuppressLint("ValidFragment")
    public dayFragment(String phone,String type) throws InterruptedException {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        lineChart = (LineChartView)view.findViewById(R.id.line_chartDay);
