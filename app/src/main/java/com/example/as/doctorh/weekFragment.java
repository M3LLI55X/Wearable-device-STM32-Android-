...
public class weekFragment extends Fragment {
    ...
    private final String scale="weeks";
    private LineChartView lineChart;

    String[] time = {"周一","周二","周三","周四","周五","周六","周日"};//X轴的标注
    ...
    @SuppressLint("ValidFragment")
    public weekFragment(String phone , String type)throws InterruptedException{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        lineChart = (LineChartView)view.findViewById(R.id.line_chartWeek);
