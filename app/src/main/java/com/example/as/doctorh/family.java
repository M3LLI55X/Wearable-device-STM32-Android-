    ...
    public void dialogNormal(){
        ...
        DialogInterface.OnClickListener dialogOnClick = new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                client userDel = list.get(listNum);
                switch (i){
    ...
    public void dialogList(){
        ...
        builder.setItems(items, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                ...
                //拿到当前选中项的 User 对象
                client userNum = list.get(listNum);
                Intent intent;
                switch (i){
                    //拨打电话
                    ...
                    case 1: intent = new Intent(Intent.ACTION_SENDTO);
                        ...
                        startActivity(intent);
                        break;
                    case 2: intent = new Intent(family.this,AddData.class);
    ...
    public void onClick(View view) {
        switch (view.getId()){
            case R.id.main_but:
                ...
                Intent intent = new Intent(family.this,AddData.class);
